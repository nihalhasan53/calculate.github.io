        ...
        WebuiPopover.prototype = {
            ...
            */
            ...
            displayContent: function() {
                ...
                if (this.options.type === 'iframe') {
                    ...
                    var iframeWidth = $target.width() - 20;
                    var iframeHeight = $iframe.parent().height() - 60;
            ...
            */
            ...
            initTargetEvents: function() {
                ...
                this.$target.find('.close').off('click').on('click', $.proxy(this.hide, this, true)).on('click', $.proxy(function() {
                    parent.initialise();
                }, this, true));
                //			this.$target.find('.close');
